package com.nxtSolutions.common.utils.cucumber;

import com.nxtSolutions.common.ui.base.BaseWebDriver;
import com.nxtSolutions.common.ui.uiAutomation.ScreenShot;
import com.nxtSolutions.common.utils.screenRecord.ScreenRecorderUtil;
import org.junit.jupiter.api.AfterAll;
import org.monte.screenrecorder.ScreenRecorder;
import com.nxtSolutions.common.utils.timer.MyTimer;
...
import com.nxtSolutions.common.utils.logs.MyLogger;
...
//    }
    ...
    public void executionStarted() {
        log.info("""
                ...
                """);
        try {
            log.info("Screen Record Started.");
            ScreenRecorderUtil.startRecord("Run");
        } catch (Exception e) {
            log.error("Couldn't Start Screen Recording.");
    ...
    public void executionFinished() {
        log.info("""
                ...
                """);
        try {
            log.info("Screen Record Stopped.");
            ScreenRecorderUtil.stopRecord();
        } catch (Exception e) {
            log.error("Couldn't Stop Screen Recording.");
            throw new RuntimeException(e);
        }
    }
}
